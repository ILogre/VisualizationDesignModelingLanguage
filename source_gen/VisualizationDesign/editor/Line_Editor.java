...
public class Line_Editor extends DefaultNodeEditor {
  ...
  private EditorCell createRefNodeList_78ent8_b0(EditorContext editorContext, SNode node) {
    AbstractCellListHandler handler = new Line_Editor.cellsListHandler_78ent8_b0(node, "cells", editorContext);
  ...
  private static class cellsListHandler_78ent8_b0 extends RefNodeListHandler {
    public cellsListHandler_78ent8_b0(SNode ownerNode, String childRole, EditorContext context) {
  ...
  private EditorCell createConstant_78ent8_c0(EditorContext editorContext, SNode node) {
